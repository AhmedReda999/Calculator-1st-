package com.example.calculator1st;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button num5 =findViewById(R.id.numo5);
        ...
        Button off =findViewById(R.id.numoff);
    ...
    on.setOnClickListener(view ->{
        ...
        equal.setOnClickListener(view->{
            double seccondNum = Double.parseDouble(screen.getText().toString());
            double result;
            switch (operation){
                case "/":
